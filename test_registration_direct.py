#!/usr/bin/env python3
"""
Test Wall Street Survivor - REGISTRATION with Direct Registration Button Click
This script finds and clicks the Register button directly using JavaScript
"""
import asyncio
import json
...
async def test_wallstreet_registration_direct():
    print("="*80)
    print("🧪 WALL STREET SURVIVOR - DIRECT REGISTRATION TEST")
    print("="*80)
    ...
    # Create registration test persona with SPECIAL INSTRUCTIONS
    test_persona = {
        'nom': 'New User',
        ...
        'special_instructions': 'Use JavaScript to find the Register button by searching the DOM for elements containing "Register" text if the accessibility tree does not show it.'
    }
...
if __name__ == "__main__":
    asyncio.run(test_wallstreet_registration_direct())
